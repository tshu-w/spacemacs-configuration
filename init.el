...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(helm-dash org-brain magithub exec-path-from-shell)
